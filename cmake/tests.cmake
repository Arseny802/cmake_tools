...
function(setup_project_tests)
  ...
  if(NOT ARG_SOURCES)
    message(FATAL_ERROR "SOURCES or SOURCES_PATH argument is required for ${ARG_TARGET_NAME}")
  endif()
  ...
  if(NOT TARGET GTest::gmock_main)
    message(WARNING "${PROJECT_NAME} > Could not find GTest::gmock_main - tests will not be created.")
    return()
  endif()
